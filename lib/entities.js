...
var world = function() {
  ...
  self.addAsteroids = function() {
    ...
    a2 = new asteroid(self, 600, 300, 100);
...
var player = function(world, id, username) {
  ...
  bodyDef.position.x = asteroidCenter.x + offsetX;
  bodyDef.position.y = asteroidCenter.y + offsetY;
  ...
  console.log('theta: ' + randAngle + ' bodyAngle: ' + self.angle + ' dist: ' + self.x + ' ' + self.y);
  console.log(leastPopAsteroid.radius/box2DScale);
