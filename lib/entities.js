...
module.exports = function() {
  var entities = {
    ...
    world: function() {
      ...
      a1 = new entities.asteroid(newWorld, 10, 10, 5);
      a2 = new entities.asteroid(newWorld, 30, 30, 10);
      a3 = new entities.asteroid(newWorld, 50, 20, 8);
      newWorld.asteroids = [a1, a2, a3];
      return newWorld;
    },
